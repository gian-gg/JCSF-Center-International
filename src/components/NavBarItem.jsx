...
const NavBarItem = ({ to, title, isBordered }) => {
  ...
  return (
    <div className="animate-slideInRight lg:animate-slideInLeft hover:scale-110 hover:-translate-y-1 hover:opacity-60 transition-transform duration-500 cursor-pointer">
